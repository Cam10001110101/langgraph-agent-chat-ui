...
- `NEXT_PUBLIC_API_URL`: The URL of your website + `/api`. This is how you connect to the API proxy. For the [Agent Chat demo](https://langgraph-ui.demos.buiid), this would be set as `https://langgraph-ui.demos.buiid/api`. You should set this to whatever your production URL is.
